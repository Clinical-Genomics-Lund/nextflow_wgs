...
| `COV_INTERNAL_LIST`       | CNV                  |         | List of pre-calculated intervals to use in `gatk CollectReadCount` ([more info](https://gatk.broadinstitute.org/hc/en-us/articles/360037427371-PreprocessIntervals-BETA-))                                                                              |
| `GATK_PON_MALE`           | CNV                  |         | Gender specific panel of normals used in `DenoiseReadCounts` GATK step                                                                                                                                                                                  |
| `GATK_PON_FEMALE`         | CNV                  |         | Gender specific panel of normals used in `DenoiseReadCounts` GATK step                                                                                                                                                                                  |
...
| `loqusdb`                 | LoqusDB              |         | Path-name to the `loqusdb` from which to retrieve local artifact frequencies                                                                                                                                                                            |
| `panelsdef`               | Scout                |         | Location of panels used in Scout (?)                                                                                                                                                                                                                    |
