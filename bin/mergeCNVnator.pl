...
sub merge {
    ...
    my @info_fields_to_comma_merge = ("natorP1", "natorP2", "natorP3", "natorP4", "natorQ0", "natorRD");
	...
	if( @agg ) {
		...
		$var .= "\t";
		my @info_fields;
		for ("END", "SVLEN", "SVTYPE", "natorP1", "natorP2", "natorP3", "natorP4", "natorQ0", "natorRD") {
